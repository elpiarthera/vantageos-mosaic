 ...
 */
export { Badge } from "./Badge.preact.js";
 ...
 * tsup preact pass aliases react → preact/compat — no source duplication required.
 */
export { StreamingTableView, TableView } from "./TableView.preact.js";
export type {
