 ...
 *
 * Preact runtime — `react` / `react-dom` are aliased to `preact/compat` at
 * tsup build time per Standard §18.2. JSX is identical to the React runtime;
 * runtime-agnostic logic lives in `src/components/forms/Input.logic.ts`.
 */
