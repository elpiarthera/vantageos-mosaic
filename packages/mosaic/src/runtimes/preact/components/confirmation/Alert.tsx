...
// Note: uses React-compat prop names (className, strokeWidth) for TSC compliance.
// Preact/compat accepts both className and class at runtime.
// tsup aliases react → preact/compat at build time per §18.1 architecture standard.
...
/**
 * Alert — persistent inline banner (Preact 10 implementation).
 *
