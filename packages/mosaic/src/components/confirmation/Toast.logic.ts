 ...
 * Tests live in __tests__/Toast.logic.test.ts (co-located schema/logic layer).
 */
 ...
 * Using ring-1 for a subtle border instead of shadow (more accessible on varied backgrounds).
 */
